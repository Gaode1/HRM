...
public class AuthenticationDbContext: IdentityDbContext<User, Role, Guid, IdentityUserClaim<Guid>, 
    UserRole, IdentityUserLogin<Guid>, IdentityRoleClaim<Guid>,IdentityUserToken<Guid>>
{
    ...
    private void ConfigureUser(EntityTypeBuilder<User> builder)
    {
        ...
        builder.HasMany(e => e.RolesForThisUser)
            .WithOne(e => e.User)
    ...
    private void ConfigureRole(EntityTypeBuilder<Role> builder)
    {
        ...
        builder.HasMany(e => e.UsersForThisRole)
            .WithOne(e => e.Role)
